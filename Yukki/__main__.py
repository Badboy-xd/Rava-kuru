...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! Tesla Music Bot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("ganda_pipul")
            await ASS_CLI_1.join_chat("EnglishHindi_Chatting_Group")
        except:
            pass
